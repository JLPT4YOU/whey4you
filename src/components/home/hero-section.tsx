...
export function HeroSection({ initialProducts = [] }: HeroSectionProps) {
  ...
  // Get all featured products from live DB
  ...
  }, [isHovered, nextSlide, featuredProducts.length]);
        ...
        <div className="flex flex-col items-center text-center space-y-4 sm:space-y-5 max-w-4xl mx-auto">
          ...
          {currentProduct ? (
                ...
                <AnimatePresence mode="wait" initial={false}>
                  ...
                  >
                    <p className="text-[11px] sm:text-xs font-black text-[#0055FE] uppercase tracking-widest">
                      {currentProduct.categoryName || 'SẢN PHẨM'} • {currentProduct.badge || 'NỔI BẬT'}
                    </p>
            ...
            <div className="pt-2 flex items-center justify-center">
              <Link
                href="/products"
                className="btn-w4u-primary px-8 py-3.5 font-bold text-sm rounded-full transition-all active:scale-95 flex items-center gap-2 shadow-lg shadow-blue-500/20"
              >
